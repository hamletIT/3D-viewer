...
@section('content')
    <div class="mb-8">
        ...
        <h1 class="text-2xl font-bold tracking-tight mt-2">Add Plan</h1>
    </div>
        ...
        <form method="POST" action="{{ route('admin.plans.store') }}">
            ...
            <div class="grid grid-cols-2 gap-4 mb-5">
                <div>
                    ...
                    <input type="number" id="max_sessions" name="max_sessions" value="{{ old('max_sessions', 5) }}" required
                        class="w-full rounded-lg bg-gray-800 border border-gray-700 px-4 py-2.5 text-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none transition-colors">
                ...
                <div>
                    ...
                    <input type="number" id="max_objects_per_scene" name="max_objects_per_scene" value="{{ old('max_objects_per_scene', 5) }}" required
                        class="w-full rounded-lg bg-gray-800 border border-gray-700 px-4 py-2.5 text-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none transition-colors">
                    <p class="mt-1 text-xs text-gray-500">Use -1 for unlimited</p>
            ...
            <button type="submit" class="px-6 py-2.5 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-sm font-medium transition-colors">Create Plan</button>
        </form>
    </div>
@endsection
