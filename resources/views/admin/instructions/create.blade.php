...
@section('content')
    <div class="mb-8">
        ...
        <h1 class="text-2xl font-bold tracking-tight mt-2">Add Instruction</h1>
    </div>
        ...
        <form method="POST" action="{{ route('admin.instructions.store') }}" enctype="multipart/form-data">
            ...
            <div class="mb-5">
                ...
                <textarea id="content" name="content" rows="8" required
                    class="w-full rounded-lg bg-gray-800 border border-gray-700 px-4 py-2.5 text-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none transition-colors">{{ old('content') }}</textarea>
            ...
            <div class="mb-5">
                <label for="image" class="block text-sm font-medium mb-2">Image / Schema (optional)</label>
            ...
            <button type="submit" class="px-6 py-2.5 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-sm font-medium transition-colors">Create Instruction</button>
        </form>
    </div>
@endsection
