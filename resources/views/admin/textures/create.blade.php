...
@section('content')
    <div class="mb-8">
        ...
        <h1 class="text-2xl font-bold tracking-tight mt-2">Add Texture</h1>
    </div>

    <div class="max-w-2xl rounded-xl bg-gray-900/60 border border-gray-800 p-6">
        <form method="POST" action="{{ route('admin.textures.store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-5">
                <label for="image" class="block text-sm font-medium mb-2">Image File</label>
            ...
            <button type="submit" class="px-6 py-2.5 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-sm font-medium transition-colors">Upload Texture</button>
        </form>
    </div>
@endsection
